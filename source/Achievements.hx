...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["IDK Friday",	"Play IDK LOL on a Friday Night.",						'friday_night_play',	 true],
		["Amazing Movement!",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["Sick Burns",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			false],
